...
public class JavaLineStyler implements LineStyleListener {
    ...
    ArrayList blockComments = new ArrayList();
    ...
    List<StyleRange> errorStyles;

    public JavaLineStyler(List<StyleRange> errorStyles) {
    ...
    boolean inBlockComment(int start, int end) {
        for (int i = 0; i < blockComments.size(); i++) {
            int[] offsets = (int[]) blockComments.get(i);
